...
var NODE_NAME = 'ros_lient';
var LOGGER_NAME = 'ros_client_logger';
 ...
 */
var RosClientNode = /** @class */ (function () {
    function RosClientNode() {
    }
    /**
     ...
     */
    RosClientNode.prototype.run = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.temperatureSubscription = this.node.createSubscription('sensor_msgs/msg/Temperature', TOPIC, undefined, function (msg) {
                            _this.logger.info(JSON.stringify(msg));
                        });
    ...
    return RosClientNode;
}());
exports.RosClientNode = RosClientNode;
var client = new RosClientNode();
client.run();
